...
subplot1(1)
%contourf(x,time,pl')
contourf(x,time,50*(pv1'-0*j*mean(pv1')),5)
set(gca,'YDir','normal')
colorbar
ylabel('days')
%title(' v_1  (m/s)')
...
subplot1(2)
%contourf(x,time,pl')
contourf(x,time,50*(pv2'-0*j*mean(pv2')),5)
set(gca,'YDir','normal')
colorbar
...
subplot1(3)
%contourf(x,time,pl')
contourf(x,time,15*(pt1'-0*j*mean(pt1')),5)
set(gca,'YDir','normal')
colorbar
ylabel('days')
...
subplot1(4)
%contourf(x,time,pl')
contourf(x,time,15*(pt2'-0*j*mean(pt2')),5)
set(gca,'YDir','normal')
colorbar
...
subplot1(5)
%contourf(x,time,pl')
contourf(x,time,15*(pteb'-0*j*mean(pteb')),5)
set(gca,'YDir','normal')
colorbar
ylabel('days')
...
subplot1(6)
%contourf(x,time,pl')
contourf(x,time,15*(pq'-0*j*mean(pq')),5)
set(gca,'YDir','normal')
colorbar
...
subplot1(7)
%contourf(x,time,pl')
h=contourf(x,time,(100*pfd'-0*j*mean(pfd')),10,'LineStyle','none');
...
subplot1(8)
%contourf(x,time,pl')
contourf(x,time,(100*pfc'-0*j*mean(pfc')),10,'LineStyle','none')
%set(gca,'YDir','normal')
colorbar
xlabel('(x1000)KM ')
